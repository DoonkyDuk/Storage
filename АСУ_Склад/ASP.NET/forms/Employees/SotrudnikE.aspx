...
<div>
	<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlТабельный_НомерLabel" runat="server" Text="Табельный_ номер" EnableViewState="False">
</asp:Label>
<ac:AlphaNumericTextBox CssClass="descTxt" ID="ctrlТабельный_Номер" Type="Numeric" runat="server">
